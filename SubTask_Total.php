  <?php 
    session_start();
    $isTouch = isset( $_SESSION["TaskPoID"] );
    if($isTouch==null){
        ...
        <?php }?>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="main.php">หน้าแรก</a></li>
              ...
              <li class="breadcrumb-item active">งานย่อยทั้งหมด</li>
            </ol>
          </div>
          <div class="page-content container-fluid">
              ...
              <div class="panel">
                ...
                <?php 
                                ...
                                if($totalEmphasis >0  && $checkstatustask !="viewtask"){?>  <a href="configpage.php?addsubtasks=<?php echo  $TaskPoID;?>" style="color:#fff;" class="btn btn-primary">เพิ่มงานย่อย  <i class="fa fa-plus"></i></a><?php }
                                else { if($checkstatustask =="viewtask"){} else{?>  <button class="btn btn-danger">ไม่สามารถเพิ่มงานย่อยได้แล้ว</button><?php }}
                ?>
                </p>
                      ...
                      <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                        ...
                        <tbody>
                          ...
                          <tr>
                                ...
                                <?php if($checkstatustask =="viewtask"){ ?>
                                    <a href="configpage.php?viewsubtaskss=<?php echo $row['TaskID'];?>" class="btn btn-info  btn-xs viewdata" name="ดูข้อมูล">ดูข้อมูล</a>
                                <?php } 
                                   else {?>
                                    <a href="configpage.php?viewsubtaskss=<?php echo $row['TaskID'];?>" class="btn btn-info  btn-xs viewdata" name="ดูข้อมูล">ดูข้อมูล</a>
                                    <a href="configpage.php?editsubetasks=<?php echo $row['TaskID'];?>"  class="btn btn-warning  btn-xs edite" id="<?php echo $row['TaskPoID']; ?>"  name="แก้ไขข้อมูล">แก้ไขข้อมูล</i></a>
                                    <a herf=""  class="btn btn-danger btn-xs delete" id="<?php echo $row['TaskID']; ?>"  name="<?php echo $row['TaskPoName']; ?>" data-target="#examplePositionCenter" data-toggle="modal">ลบข้อมูล</a>
                                <?php }?>
                                </span>
												      </div>
											      </td>
											      <td>
                              <p class="text-top"><?php echo $row['TaskStatus']; ?></p>
                            </td>
