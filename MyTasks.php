<?php 
  session_start();
       ...
       $ProjectID='';
       $myTasks='';
       if(isset( $_SESSION["statusproject"])){ $statusproject =$_SESSION["statusproject"]; }
       if(isset( $_SESSION["myProjectID"])){ $ProjectID =$_SESSION["myProjectID"]; }
       if(isset( $_SESSION["myTasks"])){ $myTasks =$_SESSION["myTasks"]; }
  ...
  <body class="animsition dashboard">
    ...
    <div class="page">
      <div class="page-header">
        <?php  if($myTasks=="viewtasks")   { ?>
          <h1 class="page-title">งานทั้งหมดที่รับผิดชอบ</h1>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="MyProject.php">โครงการทั้งหมดที่รับผิดชอบ</a></li>
            <li class="breadcrumb-item active">งานทั้งหมดที่รับผิดชอบ</li>
          </ol>
      </div>
                  ...
                  <div class="nav-tabs-horizontal" data-plugin="tabs">
                    <ul class="nav nav-tabs" role="tablist">
                      <li class="nav-item" role="presentation"><a class="nav-link active" data-toggle="tab" href="#exampleTabsOne"
                          aria-controls="exampleTabsOne" role="tab">แสดงงานทั้งหมด</a></li>
                      <li class="nav-item exampleTabsTwo" role="presentation"><a class="nav-link" data-toggle="tab" href="#exampleTabsTwo"
                          aria-controls="exampleTabsTwo" role="tab">แสดงไทม์ไลน์</a></li>
                    ...
                    <div class="tab-content pt-20">
                      <div class="tab-pane active" id="exampleTabsOne" role="tabpanel">
                           <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                            ...
                            <tbody>
                            <?php 
                                  $sql = "SELECT  ch3.*,ch2.* ,ch4.*,ch1.* FROM taskprojects AS ch1 
                                      INNER JOIN assigntaskproject AS ch2 ON (ch1.TaskPoID = ch2.TaskPoID) 
                                      INNER JOIN memberproject AS ch3 ON (ch2.MemberProjectID = ch3.MemberProjectID)
                                      INNER JOIN employee AS ch4 ON (ch3.EmployeeID = ch4.EmployeeID) 
                                      WHERE ch4.EmployeeID='".$_SESSION["Employee"]."' AND ch1.TaskPoSituation='proceed'";
                                  $stmt = $conn->prepare($sql);
                                  $stmt->execute();
                                  while ($row = $stmt->fetch()) {
                                      $progressnew =0;
                                      $TaskPoID='';
                                      $sqlww = "SELECT * FROM task where TaskPoID = '".$row['TaskPoID']."' AND TaskSituation = 'proceed'";
                                      $stmtww = $conn->prepare($sqlww);
                                      $stmtww->execute();
                                  while ($rowww = $stmtww->fetch()) 
                                    {
                                            $progressnew += (($rowww['TaskEmphasis'])*($rowww['TaskProgress'])/100);  
                                            $TaskPoID= $row['TaskPoID'];
                                      }
                                  if($progressnew!=$row['TaskPoProgress'] && $progressnew!=0){
                                         $datapm = [
                              ...
                              <tr>
                                <td>
                                  <div class="imageWrapper">
                                    <span>
                                      <?php if($row['AssignTaskPoPosition'] == "Task-Member" && $row['MemberProjectPosition'] == "Project-Member"){ ?>
                                          <a href="configpage.php?myTaskPoID=<?php echo $row['TaskPoID']; ?>&statustask=viewsubtask" class="btn-links text-title"  value="<?php echo $row['TaskPoID']; ?>" style="text-decoration: none;" ><?php echo $row['TaskPoName']; ?>  ( <?php echo $row['TaskPoEmphasis']; ?>% )</a>
                                        <?php }
                                        else{?>
                                          <a href="configpage.php?myTaskPoID=<?php echo $row['TaskPoID']; ?>&progress=<?php echo $row['TaskPoProgress']; ?>" class="btn-links text-title"  value="<?php echo $row['TaskPoID']; ?>" style="text-decoration: none;" ><?php echo $row['TaskPoName']; ?>  ( <?php echo $row['TaskPoEmphasis']; ?>% )</a>
                                        <?php } ?>
                                    </span>
                                    <span class="cornerLink">
                                      ...
                                      <?php } 
                                        ...
                                        <a herf=""  class="btn btn-danger btn-xs deletetasks" id="<?php echo $row['TaskPoID']; ?>"  name="<?php echo $row['TaskPoName']; ?>" data-target="#examplePositionCenter" data-toggle="modal">ลบข้อมูล</a>
                                      <?php }?>
                                    </span>
                                  </div>
                                </td>
                                <td>
                                  <p class="text-top"><?php echo $row['TaskPoStatus']; ?></p>
                                </td>
              ...
              <div class="panel-body">
                <p>
                  <?php 
                              ...
                              if($totalEmphasis >0 && $statusproject !="viewproject"){?>  
                                 <a href="configpage.php?addtasks=<?php echo  $idtasks;?>" style="color:#fff;" class="btn btn-success">เพิ่มงาน  <i class="fa fa-plus"></i></a>
                              ...
                              <?php }
                                  ...
                                  if($statusproject =="viewproject"){} 
                                  else{?>  
                                    <button class="btn btn-danger">ไม่สามารถเพิ่มงานได้แล้ว</button><?php 
                                      }
                               }
                  ?>
                </p>
              <div class="example-wrap">
                <div class="nav-tabs-horizontal" data-plugin="tabs">
                  <ul class="nav nav-tabs nav-tabs-reverse" role="tablist">
                    <li class="nav-item exampleTabsReverseOne1" role="presentation"><a class="nav-link active show" data-toggle="tab" href="#exampleTabsReverseOne1" aria-controls="exampleTabsReverseOne1" role="tab" aria-selected="true">แสดงงานทั้งหมด</a></li>
                    <li  class="nav-item exampleTabsReverseTwo2" role="presentation" style=""><a class="nav-link" data-toggle="tab"  href="#exampleTabsReverseTwo2" aria-controls="exampleTabsReverseTwo2" role="tab" aria-selected="false" onload="mm()">แสดงไทม์ไลน์</a></li>
                    <li class="dropdown nav-item" role="presentation" style="display: none;">
                      <a class="dropdown-toggle nav-link" data-toggle="dropdown" href="#" aria-expanded="false">Dropdown </a>
                      <div class="dropdown-menu" role="menu">
                        <a class="dropdown-item" data-toggle="tab" href="exampleTabsReverseOne1" aria-controls="exampleTabsReverseOne1" role="tab" style="display: none;">แสดงงานทั้งหมด</a>
                ...
                <div class="tab-content pt-20">
                  <div class="tab-pane active show" id="exampleTabsReverseOne1" role="tabpanel">
                    <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                      <thead>
                        <tr>
                          <th>ชื่องาน</th>
                      ...
                      <tbody>
                          <?php 
                            $sql = "SELECT f2.*,f1.* FROM taskprojects AS f1
                            INNER JOIN assigntaskproject AS f2 ON (f1.TaskPoID= f2.TaskPoID)
                            where f1.ProjectID = '".$ProjectID."' AND f1.TaskPoSituation='proceed' GROUP BY f1.TaskPoID";
                                $stmt = $conn->prepare($sql);
                                $stmt->execute();
                                while ($row = $stmt->fetch()) {
                                    ...
                                    while ($rowww = $stmtww->fetch()) 
                                    {
                                     ...
                                     $progressnew = number_format($progressnew,2);
                                    if($progressnew!=$row['TaskPoProgress']  && $progressnew!=0)
                                    {
                                          $datapmm = [
                                            'TaskPoProgress' => $progressnew,
                                        ...
                                        $sqlpmm = "UPDATE taskprojects SET 
                                        TaskPoProgress=:TaskPoProgress
                                        WHERE TaskPoID=:TaskPoID";
                                        ...
                                        $dataActi = [
                                          'ActivitiesName' =>"แก้ไขความคืบหน้างาน",
                                          'ActivitiesDate' =>  $dateActi,
                                          'ActivitiesTaskPoID' =>$row['TaskPoID'],
                                          'AssignTaskPoID' => $_SESSION["Employee"]
                                      ];
                                      $sqlActi = "INSERT INTO activitiestaskproject (ActivitiesName, ActivitiesDate, ActivitiesTaskPoID,AssignTaskPoID)
                                        VALUES (:ActivitiesName, :ActivitiesDate, :ActivitiesTaskPoID,:AssignTaskPoID)";
                        ...
                        <tr>
                            ...
                            <div class="imageWrapper">
                              <span>
                                <?php 
                                   $chkmanager=null;
                                   $chkpjmanager=null;
                                   $sqlww = "SELECT f2.*,f1.*,f3.*,f4.* FROM taskprojects AS f1
                                            INNER JOIN assigntaskproject AS f2 ON (f1.TaskPoID = f2.TaskPoID)
                                            ...
                                            where (f1.TaskPoID = '".$row['TaskPoID']."' AND f1.TaskPoSituation='proceed') AND f4.EmployeeID='".$_SESSION["Employee"]."' GROUP BY f1.TaskPoID";
                                                 $stmtww = $conn->prepare($sqlww);
                                                 $stmtww->execute();
                                                 while ($rowww = $stmtww->fetch()) 
                                                 {
                                                    $chkmanager=$rowww['AssignTaskPoPosition'];
                                                    $chkpjmanager=$rowww['MemberProjectPosition'];
                                                  }
                                                     if($chkmanager==null){ $chkmanager ="Task-Member"; }
                                                     if($chkpjmanager==null){ 
                                                        $sqlmm = "SELECT * FROM  memberproject  where EmployeeID='".$_SESSION["Employee"]."'";
                                                                      $stmtmm = $conn->prepare($sqlmm);
                                                                      $stmtmm->execute();
                                                                      while ($rowmm = $stmtmm->fetch()) 
                                                                      {
                                                                          $chkpjmanager=$rowmm['MemberProjectPosition'];
                                                                        }
                                                      }
                                ?>
                                <?php if($chkmanager == "Task-Member")
                                        {
                                          if($chkpjmanager=="Project-Manager") { ?> 
                                              <a href="configpage.php?myTaskPoID=<?php echo $row['TaskPoID']; ?>&progress=<?php echo $row['TaskPoProgress']; ?>" class="btn-links text-title"  value="<?php echo $row['TaskPoID']; ?>" style="text-decoration: none;" ><?php echo $row['TaskPoName']; ?>  ( <?php echo $row['TaskPoEmphasis']; ?>% )</a>
                                            <?php } 
                                          else { ?>
                                            <a href="configpage.php?myTaskPoID=<?php echo $row['TaskPoID']; ?>&statustask=viewsubtask&progress=<?php echo $row['TaskPoProgress']; ?>" class="btn-links text-title"  value="<?php echo $row['TaskPoID']; ?>" style="text-decoration: none;" ><?php echo $row['TaskPoName']; ?>  ( <?php echo $row['TaskPoEmphasis']; ?>% )</a>
                                            <?php } ?>
                                <?php }
                                      else{?>
                                         <a href="configpage.php?myTaskPoID=<?php echo $row['TaskPoID']; ?>&progress=<?php echo $row['TaskPoProgress']; ?>" class="btn-links text-title"  value="<?php echo $row['TaskPoID']; ?>" style="text-decoration: none;" ><?php echo $row['TaskPoName']; ?>  ( <?php echo $row['TaskPoEmphasis']; ?>% )</a>
                          ...
                          <td class="text-center">
                          <?php 
                            if($row['TaskPoProgress']==0){ $percen =  $row['TaskPoProgress'].''."%";  ?>
                                <div class="progress progress-lg progress-half-rounded m-md">
                                  <div class="progress-bar-success" role="progressbar" aria-valuenow="<?php echo $percen;?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $percen;?>; color: white;    margin-left: 45%;">
                                  <?php  echo $percen;  ?>					
                                  </div>
        ...
        <div class="modal-dialog modal-simple modal-center">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <center>
                <h3>คุณแน่ใจต้องการที่จะลบงานนี้</h3>
              </center>
            </div>
        ...
        <div class="modal-dialog modal-simple modal-sm modal-center">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>   
                <center>
                  <h3>ลบข้อมูลงานสำเร็จ!!!</h3>
                </center>
               </p>
            </div>
            <div class="modal-footer modal-center">
              <button type="button" class="btn btn-success btn-floating btn-lg successtask" data-dismiss="modal" style="font-size: 25px;">
    ...
    <script>
            var deletetask='';
            $(document).on('click', '.deletetasks', function()
                {  
            ...
            $(document).on('click', '.successtask', function()
                {  
    ...
    <script>
            $(document).on('click', '.exampleTabsTwo', function()
            {  
                jq12(document).ready(function (){
                        ...
                        var app = {};
                            ...
                            var gantt_data = [
                              <?php 
                                    include('Connnect.php');
                                    $sql = "SELECT * FROM taskprojects AS ch1 
                                    INNER JOIN assigntaskproject AS ch2 ON (ch1.TaskPoID = ch2.TaskPoID) 
                                    INNER JOIN memberproject AS ch3 ON (ch2.MemberProjectID = ch3.MemberProjectID)
                                      INNER JOIN employee AS ch4 ON (ch3.EmployeeID = ch4.EmployeeID) 
                                    WHERE ch4.EmployeeID='".$_SESSION["Employee"]."' AND ch1.TaskPoSituation='proceed'";
