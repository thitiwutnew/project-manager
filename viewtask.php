<?php 
  session_start();
$isTouch = isset( $_SESSION["idtaskss"] );
	if($isTouch==null){
		 echo '<script>window.location.href="index.php"</script>';
	}
	else{
       $idtasks= $_SESSION["idtaskss"];
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="example mt-60">
                            ...
                            data-size="200" data-barsize="8" data-goal="75" aria-valuenow="<?php echo $row['TaskPoProgress'];?>" role="progressbar">
                    ...
                    <div class="col-md-6">
                         <div class="card-block">
                            ...
                            <div class="ml-3 text-left">
                                <span><h5>น้ำหนักงาน : <a class="media-content  ml-10"><?php echo $row['TaskPoEmphasis'],"%";?> </a></h5><span>
                            </div>
                            </div>
                            <div class="media mt-10 col-md-12">
                            <div class="ml-3 text-left">
