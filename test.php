                      ...
                      <div class="tab-pane active" id="exampleTabsOne" role="tabpanel">
                           <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                            ...
                            <?php 
                                  ...
                                  if($progressnew!=$row['TaskPoProgress']){
                                         $datapm = [
                        ...
                        <div class="tab-pane" id="exampleTabsTwo" role="tabpanel">
                          ...
                          <div class="text-center">
                            <span class="badge " style="background-color:#2ECC71;">&nbsp;&nbsp;&nbsp;</span> : ชื่องาน 
                            <span class="badge " style="background-color:#ff0202;">&nbsp;&nbsp;&nbsp;</span> : ความสำคัญ สูง 
                            <span class="badge " style="background-color:#fb8c00;">&nbsp;&nbsp;&nbsp;</span> : ความสำคัญ ปานกลาง 
                            <span class="badge " style="background-color:#007bff;">&nbsp;&nbsp;&nbsp;</span> : ความสำคัญ ต่ำ
                        </div>
                      </div>
                    </div>
                  </div>
                            ...
                            <div class="imageWrapper">
                              <span>
                                <?php 
                                   $chkmanager='';
                                   $chkpjmanager='';
                                   $sqlww = "SELECT f2.*,f1.*,f3.* FROM taskprojects AS f1
                                            INNER JOIN assigntaskproject AS f2 ON (f1.TaskPoID= f2.TaskPoID)
                                ...
                                ?>
                                <?php if($chkmanager == "Task-Member" || $chkmanager==null)
                                        {
                ...
                var app = {};
                    ...
                    { name: " ",
                      ...
                      values: [{
                        from: <?php echo $start_dateqq;?>,
                        to: <?php echo $end_dateqq;?>,
                        label: "งานย่อย : <?php echo $rowww['TaskName']?> ความคืบหน้างาน : <?php echo $rowww['TaskProgress']?>%", 
                      <?php 
