<?php
  session_start();
  $isset = isset($_SESSION["ProjectIDviews"]);
	if($isset==null){
		 echo '<script>window.location.href="index.php"</script>';
	}
	else{
    $projectid = $_SESSION["ProjectIDviews"];
          ...
          <div class="card-block">
            ...
            <div class="col-xs-8">
              ...
              <!-- <div class="card-block ">
                ...
                <h2 class="card-title"><i class="icon oi-info" aria-hidden="true"></i>รายละเอียดของโครงการ</h2>
                <p class="card-text">
